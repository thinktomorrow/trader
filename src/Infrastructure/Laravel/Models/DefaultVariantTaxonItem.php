...
class DefaultVariantTaxonItem extends DefaultProductTaxonItem implements ProductTaxonItem
{
    ...
    public function __construct(string $variantId, string $productId, string $taxonId, string $taxonomyId, TaxonomyType $taxonomyType, bool $showsInGrid, TaxonState $taxonState, array $data)
    {
        $this->variantId = $variantId;

        parent::__construct($productId, $taxonId, $taxonomyId, $taxonomyType, $showsInGrid, $taxonState, $data);
    }
