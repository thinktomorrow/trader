...
{
    /** @test */
    public function in_order_to_personalise_products_as_a_visitor_I_need_to_be_able_to_add_data_to_a_cart_item()
    {
    ...
    /** @test */
    public function in_order_to_personalise_products_as_a_visitor_I_need_to_be_able_to_add_data_to_a_cart_item_while_other_data_is_left_untouched()
    {
        $this->givenThereIsAProductWhichCostsEur('lightsaber', 5);
        $this->whenIAddTheVariantToTheCart('lightsaber-123', 1, ['foo' => 'bar']);
