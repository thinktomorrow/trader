...
class OrderPromoTest extends CartContext
{
    ...
    {
        $this->givenThereIsAPromo(['promo_id' => 'aaa', 'is_combinable' => true]);
        $this->givenThereIsAPromo(['promo_id' => 'bbb', 'is_combinable' => true]);
        $this->givenThereIsAProductWhichCostsEur('lightsaber', 5);
        $this->whenIAddTheVariantToTheCart('lightsaber-123', 5);
    ...
    {
        $this->givenThereIsAPromo(['promo_id' => 'aaa', 'coupon_code' => 'foobar', 'is_combinable' => true]);
        $this->givenThereIsAPromo(['promo_id' => 'bbb', 'is_combinable' => true]);
        $this->givenThereIsAProductWhichCostsEur('lightsaber', 5);
        $this->whenIAddTheVariantToTheCart('lightsaber-123', 5);
