...
class GetDynamicValueTest extends UnitTestCase
{
    ...
    /** @test */
    function it_can_retrieve_value_as_property()
    {
        $this->assertEquals('bar',$this->stub->foo);
    }

    /** @test */
    function it_can_retrieve_value_as_method()
    {
        $this->assertEquals('bar',$this->stub->foo());
    }

    /** @test */
    function unknown_value_gives_null()
    {
    ...
    /** @test */
    function fake_method_is_only_assumed_when_no_arguments_are_passed()
    {
    ...
    /** @test */
    function value_can_be_retrieved_via_get_method()
    {
        $this->assertEquals('bar',$this->stub->getValue('foo'));
    }

    /** @test */
    function unknown_value_can_have_specific_default()
    {
        $this->assertEquals('hello',$this->stub->getValue('crazy','hello'));
    }

    /** @test */
    function nested_value_can_be_retrieved_via_dot_syntax()
    {
        $this->assertEquals('show',$this->stub->getValue('zoo.horror'));
    }

    /** @test */
    function not_found_nested_value_returns_default()
    {
        $this->assertEquals('clown',$this->stub->getValue('zoo.horrific','clown'));
    }

    /** @test */
    function nested_value_in_object_can_be_retrieved_via_dot_syntax()
    {
        $this->assertEquals('never touch it',$this->stub->getValue('hell.raiser.box'));
    }

    /** @test */
    function camelcased_also_works_for_nested_value_retrieval()
    {
    ...
    /** @test */
    function value_can_be_manipulated_at_runtime()
    {
