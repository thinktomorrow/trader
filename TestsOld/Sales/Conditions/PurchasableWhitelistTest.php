...
namespace Thinktomorrow\Trader\TestsOld\Sales\Conditions;
...
class PurchasableWhitelistTest extends TestCase
{
    ...
    public function it_can_set_parameters_from_raw_values()
    {
        ...
        $condition2 = (new PurchasableWhitelist())->setRawParameters([
            'purchasable_whitelist' => [5, 10],
        ]);

        $condition3 = (new PurchasableWhitelist())->setRawParameters([5, 10]);
