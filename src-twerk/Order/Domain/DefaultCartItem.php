...
//    private $calculatedTotal;
    ...
    {
        return $this->subTotal()->subtract($this->getDiscountTotal());
    }
    ...
    {
        return $this->getDiscounts()->reduce(function ($carry, AppliedDiscount $discount) {
    ...
    {
        $total = $this->saleTotal()->add($this->getDiscountTotal());
    ...
    public function quantifiedTotalAsString(): string
    {
        return $this->renderMoney($this->quantifiedTotal());
    }
    public function totalAsString(): string
    {
        return $this->renderMoney($this->total());
    }
    public function discountTotalAsString(): string
    {
        return $this->renderMoney($this->getDiscountTotal());
    }
    public function subTotalAsString(): string
    {
        return $this->renderMoney($this->subTotal());
    }
