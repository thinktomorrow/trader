...
use Tests\TestCase;
use Thinktomorrow\Trader\Discounts\Domain\Conditions\MaximumApplies;

class MaximumAppliesTest extends TestCase
{
    /** @test */
    public function discount_passes_when_maximum_is_not_reached()
    {
        $condition = new MaximumApplies(2, 1);
    ...
    {
        $condition = new MaximumApplies(2, 2);
