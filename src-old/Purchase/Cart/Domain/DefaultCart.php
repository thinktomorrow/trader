...
use Thinktomorrow\Trader\Purchase\Cart\Domain\Collection;
use Thinktomorrow\Trader\Purchase\Cart\Domain\DiscountableCartItemsData;
...
class DefaultCart implements Cart
{
     ...
     *
     * @return \Fulfil\Domain\FulfillableItemId
     */
