...
use Optiphar\ProductReads\ProductReadRepository;
use Optiphar\Cart\Exceptions\ProductModelNotFound;
use function collect;
use function Thinktomorrow\Trader\Purchase\Cart\Ports\array_pluck;

class OldCartItemsFactory
{
